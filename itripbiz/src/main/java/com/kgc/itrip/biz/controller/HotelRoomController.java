...
import com.kgc.itrip.beans.vo.hotelroom.SearchHotelRoomVO;
...
import com.kgc.itrip.tuils.common.DateUtil;
...
public class HotelRoomController {
    ...
    public Dto<List<ItripHotelRoomVO>> queryHotelRoomByHotel(@RequestBody SearchHotelRoomVO vo) {
        ...
        try {
            ...
            vo.setPayType(EmptyUtils.isEmpty(vo.getPayType()) ? 1 : vo.getPayType());
